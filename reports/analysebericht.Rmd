...
subtitle: "Work in Progress -- aktuelleste Version [[hier]{.ul}](https://www.dropbox.com/scl/fi/1qpggskxxumjpiexj2kwm/analysebericht.pdf?rlkey=baxspwclhphpl945nvj5nhmw6&st=zcmkrqta&dl=0) herunterladen"
...
Die unteren Abbildungen zeigen den Zusammenhang zwischen dem Listenrang (X-Achse) und dem Wahlergebnisrang (Y-Achse) für die SP, jeweils separat für die Wahlkreise Kleinbasel, Grossbasel Ost, Grossbasel West und Riehen. Jeder Punkt ist eine kandidierende Person in dem jeweiligen Wahlkreis und -jahr. Je weiter rechts eine Person auf der X-Achse liegt, desto höher ist ihr Listenrang; je weiter oben ein Punkt auf der Y-Achse liegt, desto niedriger ist der Wahlergebnisrang, d.h. desto besser ist das Wahlergebnis dieser Person.
...
Aus diesem Zusammenhang kann jedoch noch kein kausaler Listenrangeffekt ableitet werden, da es noch andere Effekte geben kann, die das Ergebnis verzerren. Wenn es beispielsweise noch zusätzlich einen Geschlechtereffekt gibt, ist die Regressionslinie (die den Listenrangeffekt widerspiegelt) dadurch zu \enquote{steil}, weil sie bei den niedrigen Listenrängen durch die guten Wahlergebnisse der Frauen nach oben \enquote{gezerrt} wird. Mit einem statistischen Modell können (und müssen) diese anderen Effekte \enquote{herausgerechnet} werden. Die von mir verwendeten Modelle werden in den kommenden Kapiteln beschrieben.
