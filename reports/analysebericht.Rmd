...
subtitle: "Work in Progress (Version 0.1.10) -- aktuellste Version [[hier]{.ul}](https://www.dropbox.com/scl/fi/1qpggskxxumjpiexj2kwm/analysebericht.pdf?rlkey=baxspwclhphpl945nvj5nhmw6&st=zcmkrqta&dl=0) herunterladen"
thanks: "Der Code und die Daten der Analysen sind auf Github abgelegt ([[Link]{.ul}](https://github.com/marcstoeckli/grossratswahlen_bs)). Ich freue mich über Kommentare und Anregungen via kontakt@stoecklieconomics.ch. Einen herzlichen Dank für ihr Feedback gehen an Tamina Graber, Edibe Gölgeli, Michela Seggiani, Salome Bessenich und Stefan Wittlin."
author: "Marc Stöckli"
...
Ein weiterer Grund für einen Listenrangeffekt ist die Praxis der Staatskanzlei, mit überzähligen Stimmen umzugehen. Auf schriftliche Nachfrage hat die Staatskanzlei Basel-Stadt bestätigt, dass aktuell die Regelung der Nationalratswahlen angewendet wird (insbesondere BPR Art. 38 Abs. 2 und 3). Diese sieht vor, dass wenn ein Wahlzettel mehr Namen als zu vergebende Sitze enthält, erst die letzten vorgedruckten nicht handschriftlich kumulierten Namen gestrichen werden, danach die letzten handschriftlich ausgefüllten Namen.
...
Im Folgenden zeige ich die Regressionsergebnisse mit dem Wahlergebnisrang als Zielgrösse. Die Ergebnisse mit dem Stimmenanteil als Zielgrösse befinden sich im Anhang (Tabellen \ref{tab:tab11} bis \ref{tab:tab19}).
