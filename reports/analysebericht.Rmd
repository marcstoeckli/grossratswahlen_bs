...
subtitle: "Work in Progress (Version 0.1.4) -- aktuellste Version [[hier]{.ul}](https://www.dropbox.com/scl/fi/1qpggskxxumjpiexj2kwm/analysebericht.pdf?rlkey=baxspwclhphpl945nvj5nhmw6&st=zcmkrqta&dl=0) herunterladen"
...
-   Werden nur die veränderten Wahlzettel betrachtet, so zeigt sich, dass der Listenrangeffekt **leicht stärker ausgeprägt ist bei den Stimmen von veränderten Wahlzetteln der SP-Liste** im Vergleich zu den Stimmen von anderen Listen (Panaschierstimmen). Anders ausgedrückt: Das Kumulieren und Streichen auf der SP-Liste führt zu einem leicht stärkeren Listenrangeffekt als das Panaschieren von SP-Kandidierenden. In Bezug auf die Anzahl der Panaschierstimmen zeigt sich zudem, dass der Listenrang einen höheren Effekt bei den amtierenden Grossrät:innen im Vergleich zu den neuen Kandidierenden hat.
...
```{r fig_1, fig.cap="Listen- und Wahlergebnisrang", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8.5, fig.align='center', fig.pos='H'}
plots <- list()
...
```{r fig_2, fig.cap="Listen- und Wahlergebnisrang", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8.5, fig.align='center', fig.pos='H'}
plots <- list()
...
Eine visuelle Betrachtung der Daten bestätigt diese Resultate. Abbildungen 3 und 4 zeigen den Listenrang auf der X-Achse und die Anzahl SP-Stimmen (Abbildung 3) bzw. Panaschierstimmen (Abbildung 4) auf der Y-Achse.[^2] Bei den Panaschierstimmen fällt auf, dass der Listenrangeffekt auf die Anzahl Stimmen (approximiert durch die Regressionslinie) bei den Amtierenden deutlich stärker ausgeprägt ist als bei den Neuen. Bei den neuen Kandidierenden ist die Regressionslinie deutlich flacher, doch reichen schon kleine Unterschiede in der Anzahl der Stimmen aus, um einen Effekt auf den Wahlergebnis*rang* zu haben (um einen besseren Wahlergebnisrang als eine andere kandidierende Person zu erreichen genügt schon eine Stimme mehr).[^3] Auffällig ist zudem, wie viel mehr Panaschierstimmen die amtierenden gegenüber den neuen Kandidierenden erhalten.
...
[^3]: Die entsprechenden Abbildungen mit dem SP- bzw. Panaschierstimmenrang auf der Y-Achse befindet sich im Anhang.
...
```{r fig_3, fig.cap="Listenrang und SP-Stimmen", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8.5, fig.align='center', fig.pos='H'}
data_final_all %>% 
  filter(party == "SP") %>% 
  mutate(incumbent = factor(incumbent, levels = c(TRUE, FALSE)),
...
```{r fig_4, fig.cap="Listenrang und Panaschierstimmen", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8.5, fig.align='center', fig.pos='H'}
data_final_all %>% 
  filter(party == "SP") %>% 
  mutate(incumbent = factor(incumbent, levels = c(TRUE, FALSE)),
         year = factor(year, levels = c(2024, 2020))) %>% 
...
```{r fig_5, fig.cap="Listenrang und SP-Stimmenrang", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
data_final_all %>% 
  filter(party == "SP") %>% 
  mutate(incumbent = factor(incumbent, levels = c(TRUE, FALSE)),
         year = factor(year, levels = c(2024, 2020))) %>% 
...
```{r fig_6, fig.cap="Listenrang und Panaschierstimmenrang", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
data_final_all %>% 
  filter(party == "SP") %>% 
  mutate(incumbent = factor(incumbent, levels = c(TRUE, FALSE)),
         year = factor(year, levels = c(2024, 2020))) %>% 
...
```{r fig_7, fig.cap="Listenrang und Stimmenanteil", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
plots <- list()
for(i in c("Kleinbasel", "Grossbasel Ost")) {
  plot <- data_final %>% 
    mutate(incumbent = factor(incumbent, levels = c(TRUE, FALSE)),
...
```{r fig_8, fig.cap="Listenrang und Stimmenanteil", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
plots <- list()
for(i in c("Grossbasel West", "Riehen")) {
  plot <- data_final %>% 
    mutate(incumbent = factor(incumbent, levels = c(TRUE, FALSE)),
...
```{r fig_11, fig.cap="Listen- und Wahlergebnisrang -- Andere Parteien", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
...
```{r fig_12, fig.cap="Listen- und Wahlergebnisrang -- Andere Parteien", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
...
```{r fig_13, fig.cap="Listen- und Wahlergebnisrang -- Andere Parteien", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
...
```{r fig_14, fig.cap="Listen- und Wahlergebnisrang -- Andere Parteien", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
...
| Partei / Liste   | Bisherige zuerst (innerhalb von) | Frauen zuerst | Alphabetisch (innerhalb von)       |
|---------------|------------------|-------------|---------------------------|
| SP (2008)        | Nein                             | Ja            | Nein                               |
| SP (2012 - 2024) | Nein                             | Ja            | Ja (Geschlecht)                    |
| Grünes Bündnis   | Ja                               | Ja            | Ja (Amtsinhaberschaft, Geschlecht) |
| BastA!           | Ja                               | Ja            | Ja (Amtsinhaberschaft, Geschlecht) |
| FDP (2020)       | Ja (Geschlecht)                  | Ja            | Ja (Amtsinhaberschaft, Geschlecht) |
| GLP              | Ja                               | Nein          | Nein                               |
| Die Mitte        | Ja                               | Nein          | Ja (Amtsinhaberschaft)             |
| SVP              | Ja                               | Nein          | Ja (Amtsinhaberschaft)             |
| GRÜNE            | Ja                               | Nein          | Ja (Amtsinhaberschaft)             |
| LDP              | Ja                               | Nein          | Ja (Amtsinhaberschaft)             |
| FDP (2024)       | Ja                               | Nein          | Ja (Amtsinhaberschaft)             |
