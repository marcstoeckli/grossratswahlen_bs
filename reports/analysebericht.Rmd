...
Im Anhang zeige ich die Abbildung der Jahre 2024 und 2020 für die restlichen Parteien bzw. Listen (Abbildung \ref{fig:fig9} bis \ref{fig:fig14}). Bei den anderen Parteien zeigt sich ein noch deutlicherer Listenrangeffekt, insbesondere bei der GLP, der SVP und der BastA!.
...
```{r fig7, fig.cap="Listenrang und Stimmenanteil", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
plots <- list()
for(i in c("Kleinbasel", "Grossbasel Ost")) {
  plot <- data_final %>% 
    mutate(incumbent = factor(incumbent, levels = c(TRUE, FALSE)),
...
```{r fig9, fig.cap="Listen- und Wahlergebnisrang -- Andere Parteien", echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=8, fig.align='center', fig.pos='H'}
